...
export const deploySafe = async (signerOrProvider: Signer | Provider, addresses: string[]): Promise<string> => {
    ...
    return await safeSdkOwner1.getAddress()
}

export const createTransaction = async (safeSdkOwner: Safe, to: string, data: string, amount: string) => {
...
export const proposeTransaction = async (signerOrProvider: Signer | Provider, safeSdkOwner: Safe, safeAddress: string, safeTx: SafeTransaction, senderAddress: string) => {
...
export const confirmTransaction = async (safeTxHash: string, signerOrProvider: Signer | Provider, safeAddress: string): Promise<SignatureResponse> => {
...
export const executeTransaction = async (safeTxHash: string, signerOrProvider: Signer | Provider,  safeAddress: string): Promise<TransactionReceipt | ContractReceipt | undefined> => {
    const safeService = getSafeService(signerOrProvider)
    const safeSdkOwner = await getSafe(safeAddress, signerOrProvider)
